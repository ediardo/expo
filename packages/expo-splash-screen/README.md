...
6. [(<em>optional</em>) Customize `resizeMode`](#-optional-customize-resizemode-in-resvaluesstringsxml)
...
If you've overridden `resizeMode` as `NATIVE` in [`res/values/strings.xml`](#-optional-customize-resizemode-in-resvaluesstringsxml), you need to do a few additional steps.
