...
@implementation ABI41_0_0EXGLView
...
- (void)setOnSurfaceCreate:(ABI41_0_0UMDirectEventBlock)onSurfaceCreate
{
...
- (void)draw
{
  ...
  // called on the JS thread to create the ABI41_0_0EXGL context and save its id (see ABI41_0_0EXGLContext.initializeContextWithBridge method).
...
#pragma mark - ABI41_0_0EXGLContextDelegate
