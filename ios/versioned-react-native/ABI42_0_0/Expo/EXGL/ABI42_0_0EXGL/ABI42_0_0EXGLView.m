...
@implementation ABI42_0_0EXGLView
...
- (instancetype)initWithModuleRegistry:(ABI42_0_0UMModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    self.contentScaleFactor = [ABI42_0_0UMUtilities screenScale];
    ...
    _glContext = [[ABI42_0_0EXGLContext alloc] initWithDelegate:self andModuleRegistry:moduleRegistry];
...
- (void)setOnSurfaceCreate:(ABI42_0_0UMDirectEventBlock)onSurfaceCreate
{
...
- (void)draw
{
  ...
  // called on the JS thread to create the ABI42_0_0EXGL context and save its id (see ABI42_0_0EXGLContext.initializeContextWithBridge method).
...
#pragma mark - ABI42_0_0EXGLContextDelegate
